...
def simulationStats(simulation):
...
if __name__ == "__main__":
    ...
    simulation = simulate(soft17, 10000)
    result = simulationStats(simulation)
    print(f"EV: {result[1]:.4f}, Var: {result[2]:.4f}, StDev: {result[3]:.4f}") 